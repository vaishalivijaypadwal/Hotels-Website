            ...
            <div className="activity-list">
              <div className="activity-item">
                <div className="activity-content">
                  <h3>Find The Best Resort For Accomodation</h3>
                  <p>
        ...
        <div className="facilities-container">
          ...
          <div className="facilities-content">
            ...
            <p className="section-description">
              Kinara Resort is located in beauty of Tarkarli. The property is located at the distance of (4.1 km) from Malvan Bus Depot and One can opt for state transport or can hire private vehicle to reach the hotel. The wide river, the beautiful sailboats and the tiny wonderful islands hamlets situated on the riverbank, add to the picturesque beauty of Tarkarli. While at Trakarli, do make it a point to taste the special Malvani food such as a variety of fish items and kombadi-vada. The hotel itself offers services that are designed to offer maximum comfort to its guests. Some of the services offered here are Wi-Fi, telephone, hot and cold water, essential toiletries and many more are been offered at the hotel. The hotel offers a myriad of conveniences to make the stay comfortable for guests.
            </p>
            </div>
        </div>
      </section>
